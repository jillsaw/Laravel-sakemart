                          ...
                          <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                              <a href="{{ route('products.show', $recommend_product) }}">
                                  @if ($recommend_product->image !== "")
                                     <img src="{{ asset($recommend_product->image) }}" class="img-thumbnail sakemart-product-img-recommend">
                                  @else
                                     <img src="{{ asset('img/dummy.png')}}" class="img-thumbnail sakemart-product-img-recommend">
                                  @endif
                              </a>
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('products.show', $recently_product) }}">
                                @if ($recently_product->image !== "")
                                    <img src="{{ asset($recently_product->image) }}" class="img-thumbnail sakemart-product-img-products">
                                @else
                                    <img src="{{ asset('img/dummy.png')}}" class="img-thumbnail sakemart-product-img-products">
                                @endif
                            </a>
                            <div class="row">
                                <div class="col-12">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('products.show', $featured_product) }}">
                                @if ($featured_product->image !== "")
                                    <img src="{{ asset($featured_product->image) }}" class="img-thumbnail sakemart-product-img-products">
                                @else
                                    <img src="{{ asset('img/dummy.png')}}" class="img-thumbnail sakemart-product-img-products">
                                @endif
                            </a>
