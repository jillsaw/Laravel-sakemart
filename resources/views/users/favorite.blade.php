                        ...
                        <div class="col-md-2">
                            <a href="{{ route('products.show', $favorite_product->id) }}">
                                @if ($favorite_product->image !== "")
                                    <img src="{{ asset($favorite_product->image) }}" class="img-thumbnail sakemart-product-img-cart">
                                @else
                                    <img src="{{ asset('img/dummy.png') }}" class="img-thumbnail sakemart-product-img-cart">
                                @endif
                            </a>
                        </div>
                        <div class="col-md-6">
                            <h5 class="w-100 sakemart-favorite-item-text"><a href="{{ route('products.show', $favorite_product->id) }}" class="link-dark">{{ $favorite_product->name }}</a></h5>
                            <h6 class="w-100 sakemart-favorite-item-text mb-0">￥{{ number_format($favorite_product->price) }}</h6>
                        </div>
                        <div class="col-md-1">
