        ...
        <div class="col-md-8">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('products.show', $product->id) }}">
                                @if ($product->options->image)
                                    <img src="{{ asset($product->options->image) }}" class="img-thumbnail sakemart-product-img-cart">
                                @else
            ...
            <div class="row justify-content-end">
                <div class="col-md-3 mb-4">
                    <a href="{{route('products.index')}}" class="btn sakemart-favorite-button text-favorite w-100">
                        買い物を続ける
                    </a>
                </div>
                ...
                <div class="col-md-3 mb-4">
                    @if ($total > 0)
                        <a href="{{ route('checkout.index') }}" class="btn sakemart-submit-button text-white w-100">購入に進む</a>
                    @else
                        <button class="btn sakemart-submit-button-disabled w-100">購入に進む</button>
                    @endif
                </div>
            </div>
        </div>
